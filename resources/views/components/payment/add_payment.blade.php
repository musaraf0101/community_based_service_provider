                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group local-forms">
                                ...
                                <input class="form-control" type="text" name="card_name" value="{{ old('card_name') }}" placeholder="Enter Card Holder Name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group local-forms">
                                <label>Card Number <span class="login-danger">*</span></label>
                                <input class="form-control" type="text" name="card_number" id="card_number" value="{{ old('card_number') }}" placeholder="Enter Card Number">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group local-forms">
                                ...
                                <input class="form-control datetimepicker" type="date" name="expire_date" value="{{ old('expire_date') }}" placeholder="DD-MM-YYYY">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group local-forms">
                                <label>CCV <span class="login-danger">*</span></label>
                                <input class="form-control" type="text" name="ccv" value="{{ old('ccv') }}" placeholder="Enter CCV">
                            </div>
                        </div>
                        <div class="col-12">
