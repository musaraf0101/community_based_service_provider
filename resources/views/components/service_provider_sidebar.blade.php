 ...
 <aside class="w-full md:w-64 bg-white shadow-lg p-6 flex flex-col">
     ...
     <nav>
         <ul class="space-y-2">
             <li>
                 <a href="/service-provider/dashboard" class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-gray-600 transition-colors duration-200">
                     Dashboard
                 </a>
             </li>
             <li>
                 <a href="{{ route('service_provider.bookings',['provider' => auth()->user()->serviceProvider->id]) }}" class="flex items-center p-3 rounded-lg hover:bg-gray-100 text-gray-600 transition-colors duration-200">
                     View Booking
                 </a>
             </li>
         </ul>
